...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("Michal Polovka");
MODULE_DESCRIPTION("Driver for Lenovo Professional Wireless Keyboard and Mouse Combo");
...
static int __init lpwk_init(void)
{
  int ret;
...
static void __exit lpwk_cleanup(void)
{
    printk(KERN_INFO "Cleaning up module.\n");
}

module_init(lpwk_init);
module_exit(lpwk_cleanup);
